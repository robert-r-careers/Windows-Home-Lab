...
# Naming Variables (used for auto-naming the server)
current_time=$(date +"%H-%M-%S")
client_name="WinSrv-$current_time"

# Create Windows Server child disks
# Windows Server VMs
sudo qemu-img create -f qcow2 -F qcow2 \
  -b /var/lib/libvirt/images/base/winsrv-base.qcow2 \
